...
import { PictureThreeColorComponent } from "./base-palette/picture-three-color/picture-three-color.component";
import { BasePaletteModule } from "./base-palette/base-palette.module";
